...
function Sidebar() {
    ...
    const setStyle = (e) => {
        let styles = e.target.parentElement.parentElement.querySelectorAll('.bg-blue-400.text-white');
    ...
    return (
        <SideBar>
            ...
            <Link to="/user/editpw">
                <div  onClick={setStyle} value="editPw" readOnly>Thay đổi mật khẩu</div>
            </Link>
        </SideBar>
    )
}
